#!/usr/bin/env python3
"""
fetch-url.py — Fetch a URL via Jina Reader, clean it, save as resources/pending markdown.
...
def main():
    parser = argparse.ArgumentParser(description="Fetch URL via Jina Reader → resources/pending/")
