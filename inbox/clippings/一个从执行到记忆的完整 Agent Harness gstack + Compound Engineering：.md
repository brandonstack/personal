...
source: "https://x.com/xxxjzuo/status/2038086450013495554"
author:
  - "[[Unknown]]"
...
上周的第二篇引入了 generator-evaluator 分离：agent 评价自己的工作会过度乐观，把做事的和评价的分成两个独立 agent，效果显著提升。Anthropic 用这套架构让 agent 自主开发了一个完整的 [claude.ai](https://claude.ai/) 克隆，200 多个可验证的 feature。

![图像](https://pbs.twimg.com/media/HEi8r2GaYAAX0jQ?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HEi8HJuXYAADDUR?format=jpg&name=large)
...
· CE：[github.com/EveryInc/compound-engineering-plugin](https://github.com/EveryInc/compound-engineering-plugin)
