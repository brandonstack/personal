...
# 2\. 概念边界：MCP / Plugin / Tools / Skills / Hooks / Subagents2. 概念边界：MCP / 插件 / 工具 / 技能 / 钩子 / 子代理
...
- 对大响应支持 response\_format: concise / detailed对大响应支持 response\_format： concise / detailed
...
Hooks + Skills + CLAUDE.md 三层叠加钩子+技能+CLAUDE.md 三层叠加
...
> "Update your CLAUDE.md so you don't make that mistake again."“更新你的 CLAUDE.md，这样你就不会再犯同样的错误。”
...
> npx skills add tw93/claude-health -a claude-code -s health -g -yNPX 技能添加 TW93/Claude-生命值 -A Claude-Code -S 健康 -G -y
