#!/usr/bin/env python3
"""
feed-to-inbox.py — Pull entries from `feed` CLI, write new ones into inbox/<source>/.

Usage:
    python3 scripts/ingest/feed-to-inbox.py [--hours 24] [--dry-run] [--keywords AI,LLM] [--min-points N]
...
def main():
    parser = argparse.ArgumentParser(description="feed CLI → personal inbox/")
