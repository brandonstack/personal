...
## [](https://huggingface.co/learn/nlp-course/chapter1#understanding-nlp-and-llms)Understanding NLP and LLMs
...
## [](https://huggingface.co/learn/nlp-course/chapter1#what-to-expect)What to expect?

Here is a brief overview of the course:

![Image 2: Brief overview of the chapters of the course.](https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter1/summary.svg)![Image 3: Brief overview of the chapters of the course.](https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter1/summary-dark.svg)
...
## [](https://huggingface.co/learn/nlp-course/chapter1#who-are-we)Who are we?
...
## [](https://huggingface.co/learn/nlp-course/chapter1#faq)FAQ
...
![Image 4: Link to the Hugging Face forums](https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter1/forum-button.png)
...
![Image 5: Link to the Hugging Face course notebooks](https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter1/notebook-buttons.png)
...
## [](https://huggingface.co/learn/nlp-course/chapter1#languages-and-translations)Languages and translations
...
![Image 6: Activating subtitles for the Hugging Face course YouTube videos](https://huggingface.co/datasets/huggingface-course/documentation-images/resolve/main/en/chapter1/subtitles.png)
...
## [](https://huggingface.co/learn/nlp-course/chapter1#lets-go-)Let’s go 🚀
